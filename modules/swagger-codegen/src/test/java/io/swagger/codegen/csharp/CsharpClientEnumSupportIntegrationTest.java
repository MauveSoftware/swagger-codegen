...
public class CsharpClientEnumSupportIntegrationTest extends AbstractIntegrationTest {
    public CsharpClientEnumSupportIntegrationTest() {
    ...
    protected IntegrationTestPathsConfig getIntegrationTestPathsConfig() {
        return new IntegrationTestPathsConfig("csharp/enums/enum-support");
    }
